...
The other success criteria for our game, has to do with performance. \todobenjamin{Skriv afsnittet i problem statement, og referrer herfra.}
...
A lot of problems\tododaniel{what problems?} arose during development, but performance was a priority throughout development. 
...
As shown in \tododennis{ref to the hardware performance tests} the game runs smoothly at X\tododennis{insert fps} fps. 
