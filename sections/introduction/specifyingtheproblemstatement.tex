...
\textit{Mobile devices} is very loosely defined in many different contexts, this report will follow Oxford Dictionary and define a mobile device as 
\begin{center}
...
He in general uses this definition as a tool to look at the gameplay. If there is \textit{a series of interesting choices}, are these satisfying for the player according to some criteria for the game? We use Sid Meier's definition.\\\\\tododaniel{why all these newlines?}
