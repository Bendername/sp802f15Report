...
\begin{center}
\textit{What is required to create a synchronous multiplayer game for mobile devices, which contains both advanced gameplay mechanics\todomichael{What is advanced gameplay mechanics? We need a definition for this.} and more complex strategical aspects compared to the common games developed for mobile devices?}
\end{center}
