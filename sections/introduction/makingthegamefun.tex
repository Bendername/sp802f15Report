...
An important part of creating a game is making it attractive to play. One way of doing is so it making it fun and according to Sid Meier\cite{GDC2012} one way of doing so is by making a series of interesting decisions.
...
\begin{itemize}
	...
	\item Personal - Do I build a lot of defensive units and \textit{turtle}\tododaniel{define turtle or use another word} in my base, or do I play aggressive and try to rush down my enemy?
...
\subsection{Remove distractions from player focus}\label{introductions:makingthegamefun:removedistractionsfromplayerfocus}
