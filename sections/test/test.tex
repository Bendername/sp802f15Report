...
This is interesting because the server handles all logic in the game, and basically instructs the clients to do ''its bidding''\tododaniel{meh, er det bare mig eller skal vi have noget mindre warcraft 3'ish word her}. 
...
One thing to note is the fact that the PC server will fluctuate 10-30\%  in FPS, whereas the mobile normally fluctuates between 0-10\% and rarely 20\%. 
