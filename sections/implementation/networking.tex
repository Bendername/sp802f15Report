\section{Networking}
Since GAME\jelly{correct this when we have found a name for the game} is a multiplayer game using multiple devices, networking is required. This section will describe the implementation of the networking parts.
