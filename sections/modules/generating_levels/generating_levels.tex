...
figure~\ref{fig:wall_vertices}. However this reveals a problem: the resulting
...
constructing the polygon. The result of our \textit{flood fill} adaptation
