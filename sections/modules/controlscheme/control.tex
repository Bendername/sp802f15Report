...
The game being developed is a shooter, see section \ref{sec:selectionofgametype:mobiledevices}, which are fairly popular with large titles like \emph{Call Of Duty}\todoanders{Missing cites} and \emph{Battlefield}\todoanders{Missing cites}
