...
\item UV Rectangle
\end{itemize}
Where the texture will be our full map, and the UV Rectangle will be used to offset and control the size of will be shown in the minimap.\todoanders{inser picture here}
\\\\
