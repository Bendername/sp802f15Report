...
Games such as \textit{Candy Crush}\cite{candycrush} has strategic aspect tied to the fact that each move the player makes will cause a series of action in the game.
