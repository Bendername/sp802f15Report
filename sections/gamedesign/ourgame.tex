...
\subsection*{The player}
 An individual player consists of a single character. This character can move freely in the game world without being constrained by what other players are doing. When killing a zombie, the player will receive experience. When a set amount of experience is reached, the player will gain a level. Gaining levels will allow the player to customize his character according to a set of traits, see the traits section \ref{gamedesign:ourgame:traits}. The player wears set of weapons, which are obtained by crafting them, see \ref{gamedesign:ourgame:crafting}. Both levelling, trait selection and crafting allow for the player to feel he is progression on multiple levels in the game. When progressing, the player receive some form of feedback, basically it should feel \emph{awesome} to level up.
